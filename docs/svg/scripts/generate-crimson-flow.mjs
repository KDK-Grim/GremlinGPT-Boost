...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
  ...
  <defs>
    ...
    <pattern id="scan" width="2" height="6" patternUnits="userSpaceOnUse">
      <rect width="2" height="1" fill="${RED}" opacity=".05"/>
    </pattern>
  </defs>
  ...
  <!-- Curve -->
  <path id="curve" d="${dPath}"
        fill="none" stroke="${RED_LINE}" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"
        stroke-dasharray="6 14" filter="url(#glow)">
